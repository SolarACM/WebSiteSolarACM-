      ...
      <section style={{ minHeight: "60vh", display: "flex", alignItems: "center", background: `radial-gradient(ellipse 80% 60% at 30% 50%, ${C.purple}10 0%, transparent 60%), ${C.dark}`, padding: "120px 2rem 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", width: "100%" }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <a href={`https://line.me/ti/p/~Monarrattana`} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 8, background: `linear-gradient(135deg, ${C.purple}, ${C.purpleLight})`, color: "white", padding: "14px 28px", borderRadius: 10, fontSize: 15, fontWeight: 600, textDecoration: "none", boxShadow: `0 8px 32px ${C.purple}44` }}>{t.btnSubmit} <ArrowRight size={18} /></a>
      ...
      <section style={{ padding: "100px 2rem", background: `linear-gradient(135deg, ${C.purple}, ${C.purpleLight})`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href={`https://line.me/ti/p/~Monarrattana`} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 8, background: "white", color: C.purple, padding: "14px 28px", borderRadius: 10, fontSize: 15, fontWeight: 600, textDecoration: "none", boxShadow: "0 8px 24px rgba(0,0,0,0.15)" }}>{t.btnSubmit} <ArrowRight size={18} /></a>
