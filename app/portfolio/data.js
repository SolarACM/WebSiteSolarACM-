...
export const projects = [
  {
    ...
    description:
      "ระบบโซลาร์รูฟท็อป On-Grid ขนาด 92.8 kWp ติดตั้งบนหลังคาอาคารบริการในจังหวัดสระบุรี รูปแบบ PPA ลูกค้าไม่ต้องลงทุน เริ่มจ่ายไฟเข้าระบบเดือนสิงหาคม 2564",
    highlights: ["PPA Project", "COD ส.ค. 2564", "92.8 kWp"],
  },
  {
    id: 2,
    title: "อาคารธุรกิจพาณิชย์ จ.ชลบุรี",
    capacity: 162,
    type: "industrial",
    province: "ชลบุรี",
    year: 2021,
    ...
    description:
      "ระบบโซลาร์รูฟท็อปขนาด 162 kWp สำหรับอาคารธุรกิจในเขตจังหวัดชลบุรี รูปแบบสัญญา PPA ลูกค้าไม่ต้องลงทุน จ่ายไฟเข้าระบบเดือนสิงหาคม 2564",
  ...
  {
    id: 6,
    title: "อาคารพาณิชย์ในโครงการอสังหาริมทรัพย์",
    capacity: 778.8,
    type: "industrial",
    province: "ภาคกลาง",
    year: 2023,
    ...
    description:
      "ระบบโซลาร์รูฟท็อป EPC ขนาด 778.8 kWp สำหรับอาคารพาณิชย์ในโครงการพัฒนาอสังหาริมทรัพย์ มุมสูงแสดงการติดตั้งครบวงจรบนหลังคาคลังสินค้าขนาดใหญ่",
    highlights: ["EPC ครบวงจร", "Commercial Property", "778.8 kWp"],
  },
  {
    id: 7,
